...
public class Writein {
	 ...
	 * @param muniNos
	 */
	public Writein(String candName, String contestTitle, int zoneNo, List<String> muniNos) {
		this.candidateName = candName;
		this.contestTitle = contestTitle;
		this.zoneNo = zoneNo;
		this.muniNos = muniNos;
		int size = muniNos.size();
		logger.debug(String.format("Creating Writein %s, %s, %d, %s...%s", candName, contestTitle, zoneNo, muniNos.get(0), muniNos.get(size-1)));
	}
	// getter
