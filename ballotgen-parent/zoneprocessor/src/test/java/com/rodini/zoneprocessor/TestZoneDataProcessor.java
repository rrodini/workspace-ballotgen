...
class TestZoneDataProcessor {
	...
	void testZoneData1() {
		...
		3,OXGrove,./src/test/java/zone-03.jpg,https://www.oxgrovedems.org/,./src/test/java/default.docx
		""";
		ZoneDataProcessor.processZonesText(root, zoneText);
		Map<String, Zone> map = root.getZoneNoZoneMap();
		Set<String> keys = map.keySet();
		assertEquals(1, keys.size());
		Zone zone1 = map.get("03");
		assertEquals("03", zone1.getZoneNo());
		assertEquals("OXGrove", zone1.getZoneName());
		assertEquals("./src/test/java/zone-03.jpg", zone1.getZoneLogoPath());
	...
	void testZoneData3() {
    	...
    	#zone no,zone name,zone logo path
		3,OXGrove,./src/test/java/zone-03.jpg,https://www.oxgrovedems.org/,./src/test/java/default.docx
	    6,Thornbury,./src/test/java/zone-06.png,http://midchescodems.org/,./src/test/java/default.docx
	    8,KAD,./src/test/java/zone-08.jpg,https://kennettareademocrats.com/,./src/test/java/default.docx
		""";
		ZoneDataProcessor.processZonesText(root, zoneText);
		Map<String, Zone> map = root.getZoneNoZoneMap();
		Set<String> keys = map.keySet();
		...
		assertEquals("./src/test/java/zone-06.png", zone2.getZoneLogoPath());
		...
		assertEquals("./src/test/java/zone-08.jpg", zone3.getZoneLogoPath());
